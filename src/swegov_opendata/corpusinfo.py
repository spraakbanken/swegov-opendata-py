corpusinfo = {
    ...
    "ds": ("rd-ds", "Departementsserien", "Utredningar från regeringens departement"),
    "EUN": (
        "rd-eun",
        "EUN",
    ...
    "kammakt": ("rd-kammakt", "Kammaraktiviteter", ""),
    "kom": (
        "rd-kom",
        "KOM",
        "EU-kommissionens förslag och redogörelser, så kallade KOM-dokument",
    ),
    "mot": ("rd-mot", "Motion", "Motioner från riksdagens ledamöter"),
    "prop": ("rd-prop", "Proposition", "Propositioner och skrivelser från regeringen"),
    "prot": ("rd-prot", "Protokoll", "Protokoll från kammarens sammanträden"),
    "rskr": (
        "rd-rskr",
        "Riksdagsskrivelse",
        "Skrivelser från riksdagen till regeringen",
    ),
    "samtr": ("rd-samtr", "Sammanträden", ""),
    "Skriftliga+frågor": (
        "rd-skfr",
        "Skriftliga frågor",
    ...
    "t-lista": ("rd-tlista", "Talarlista", "Talarlistor för kammarens sammanträden"),
    "Utredningar": (
        "rd-utr",
        "Utredningar",
    ...
    "yttr": ("rd-yttr", "Yttrande", "Utskottens yttranden"),
    "Övrigt": (
        "rd-ovr",
        "Övrigt",
